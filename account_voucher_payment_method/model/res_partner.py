...
class res_partner(osv.osv):
    ...
    _columns = {
        'customer_payment_method': fields.property(type='many2one', relation='account.journal',
            string='Forma de Pago del Cliente', view_load=True,
            help="Seleccione la forma de pago por defecto para este cliente."),
        'supplier_payment_method': fields.property(type='many2one', relation='account.journal',
            string='Forma de Pago del Proveedor', view_load=True,
            help="Seleccione la forma de pago por defecto para este proveedor."),
